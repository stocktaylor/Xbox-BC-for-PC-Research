...
See [TECHNICAL_FINDINGS.md](TECHNICAL_FINDINGS.md) for a deep-dive binary analysis, and [WINE_COMPATIBILITY.md](WINE_COMPATIBILITY.md) for notes on what would likely make this difficult to run under Wine/Proton on Linux.
